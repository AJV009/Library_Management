	...
	echo"
		<div class='w3-container w3-card-4 w3-round-large w3-pale-green' style='margin-top:13%; margin-bottom:5%; margin-left:5%; margin-right:5%'>
			<form class='w3-container' action = '' method=POST>
    				...
    				<h4 class='w3-left w3-margin-left'>Username : Once created Username wont change</h4><input class='w3-input w3-border w3-round-xxlarge' type='text' value='".$row['username']."' name='username' required disabled>
